...
def askSports():
  ...
  if sports == 'Yes':
    ...
    if whichSport == "soccer":
      ...
      print("Well that's good. I play soccer, and it's super fun and exciting.")
  elif askSports == "No":
    print("Oh, well that's alright. If you ever decide to play any sports, I recommend soccer. It's super fun and very exciting. ")
...
def askFood():
  ...
  if food == "brownies":
    ...
    if favFlavor == "vanilla" or favFlavor == "chocolate" or favFlavor == "strawberry":
      ...
      print("Those are ok flavors. Though I personally would prefer strawberry or chocolate.")
