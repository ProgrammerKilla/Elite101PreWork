"""
This programs creates a chatbot that has a
conversation with the user to get to know them better 
based of their responses and keeps on going 
...
#Main Program 
while True:
  print("Options: Hobby, Sports, Food, Career")
  topic = input("What do you want to talk about now? ")
  if topic == "Hobby":
    askHobby()
    print("----------------------------------------------")
  elif topic == "Sports":
